...
{
    [Header("유닛 정보")]
    [Tooltip("유닛 이름"), HideInInspector] public Defines.EUnit eUnit = Defines.EUnit.None;
    [Tooltip("유닛 이름 String"), HideInInspector] public string unitName = null;
    [Tooltip("유닛 레벨"), HideInInspector] public Defines.ELevel eLevel = Defines.ELevel.None;
    ...
    [Header("스킬 정보")]
    [Tooltip("스킬1 이름"), HideInInspector] public Defines.ESkill eSkill1 = Defines.ESkill.None;
    [Tooltip("스킬2 이름"), HideInInspector] public Defines.ESkill eSkill2 = Defines.ESkill.None;
    [Tooltip("스킬3 이름"), HideInInspector] public Defines.ESkill eSkill3 = Defines.ESkill.None;
    [Tooltip("스킬4 이름"), HideInInspector] public Defines.ESkill eSkill4 = Defines.ESkill.None;

    [Header("아이템 정보")]
    [Tooltip("아이템1 이름"), HideInInspector] public Defines.EItem eItem1 = Defines.EItem.None;
